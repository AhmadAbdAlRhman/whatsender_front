            ...
            <div className="cta-container">
                <div className="cta-wrapper">
                    ...
                    <div className="cta-shape cta-shape-1">
                        <img src="/frontend/CTA/cta-shape-1.png" alt="" />
                    </div>
                    <div className="cta-shape cta-shape-2">
                        <img src="/frontend/CTA/cta-shape-2.png" alt="" />
                    </div>
                    <div className="cta-shape cta-shape-3">
                        <img src="/frontend/CTA/cta-shape-3.png" alt="" />
                    </div>
                    <div className="cta-shape cta-shape-4">
                        <img src="/frontend/CTA/cta-shape-4.png" alt="" />
                    </div>
                    <div className="cta-shape cta-shape-5">
                        <img src="/frontend/CTA/cta-shape-5.png" alt="" />
                    </div>
